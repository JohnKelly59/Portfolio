 ...
 <FontAwesomeIcon icon={faIdCard} size="6x"/>
    ...
    <Fade bottom>
      <div className="col-lg-4">
        ...
        <h2>Github</h2>
        <p><a className="btn btn-secondary" href="https://github.com/JohnKelly59">View Page &raquo;</a></p>
      </div>
      </Fade>
      <Fade bottom>
      <div className="col-lg-4">
      <a href= "https://www.linkedin.com/in/john-kelly-b96b1a18a?trk=public_profile_browsemap_profile-result-card_result-card_full-click"><FontAwesomeIcon icon={faLinkedin} size="8x"/></a>
        ...
        <p><a className="btn btn-secondary" href="https://www.linkedin.com/in/john-kelly-b96b1a18a?trk=public_profile_browsemap_profile-result-card_result-card_full-click">View Page &raquo;</a></p>
      </div>
      </Fade>
      <Fade bottom>
      <div className="col-lg-4">
      <a href="mailto:batboy.john91@gmail.com"><FontAwesomeIcon icon={faEnvelope} size="8x"/></a>
        ...
        <h2>Mail</h2>
        <p><a className="btn btn-secondary" href="mailto:batboy.john91@gmail.com">View Page &raquo;</a></p>
      </div>
      </Fade>
    </div>
</div>
